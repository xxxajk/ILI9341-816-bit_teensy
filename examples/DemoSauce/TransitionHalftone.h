...
public:
        ...
        void restart(ILI9341_TFT tft, uint_fast16_t color);
...
void TransitionHalftone::init(ILI9341_TFT tft) {

}

void TransitionHalftone::restart(ILI9341_TFT tft, uint_fast16_t inColor) {
...
void TransitionHalftone::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
