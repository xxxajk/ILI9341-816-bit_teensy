...
void TwistyText::init(ILI9341_TFT tft) {
...
void TwistyText::reset(ILI9341_TFT tft) {
...
void TwistyText::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
        ...
        for(uint_fast8_t c = 0; c < (CHARS_PER_LINE * 7); c++) {
                ...
                switch(lineIdx) {
                        case 0: baseColor = 0x22ffff;
                                break; // "HYDRONICS"
                        case 1: baseColor = 0xffff44;
                                break; // "+ ZKARCHER"
                        case 2: baseColor = 0xff22ff;
                                break; // "PRESENT"
                        case 3: baseColor = 0x33ff88;
                                break; // "SUPER-TFT!";
                        default: baseColor = 0xbb0000;
                                break; // hearts
                }
