...
void TransitionDither::init(ILI9341_TFT tft) {

}

void TransitionDither::restart(ILI9341_TFT tft, uint_fast16_t inColor) {
...
void TransitionDither::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
