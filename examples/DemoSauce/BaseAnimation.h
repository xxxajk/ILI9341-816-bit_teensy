...
public:
        ...
        virtual void reset(ILI9341_TFT tft);
...
void BaseAnimation::init(ILI9341_TFT tft) {
        // Extend me
}
...
void BaseAnimation::reset(ILI9341_TFT tft) {
        // Extend me
}
...
void BaseAnimation::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
        // Extend me
}
