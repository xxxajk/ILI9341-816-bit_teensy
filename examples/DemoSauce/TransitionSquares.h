...
void TransitionSquares::init(ILI9341_TFT tft) {

}

void TransitionSquares::restart(ILI9341_TFT tft, uint_fast16_t inColor) {
...
void TransitionSquares::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
