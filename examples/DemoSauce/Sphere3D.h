...
private:
        void _drawLine(ILI9341_TFT tft, float cosTilt, float sinTilt, float x, float y, float z, uint_fast16_t w_2, uint_fast16_t h_2, uint_fast16_t color);
...
void Sphere3D::init(ILI9341_TFT tft) {
...
void Sphere3D::_drawLine(ILI9341_TFT tft, float cosTilt, float sinTilt, float x, float y, float z, uint_fast16_t w_2, uint_fast16_t h_2, uint_fast16_t color) {
        // Tilt!
        float tempY = y;
...
void Sphere3D::perFrame(ILI9341_TFT tft, FrameParams frameParams) {
